function sens = espirit(calib, imsize, kernel, eig_thresh, mask_thresh)
%
...
% Matlab implementation of espirit: taken from Mark Chiew's software package
% https://github.com/mchiew/vtMRI_Radial/blob/main/bin/rx_espirit.m
%
