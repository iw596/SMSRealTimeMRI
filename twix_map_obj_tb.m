classdef twix_map_obj_tb < matlab.mixin.Copyable %handle
...
methods
    % Constructor:
    function this = twix_map_obj_tb(arg,dataType,fname,version,readType,scanNumber,rstraj)
...
%         end
    ...
    function this = clean(this)
        ...
        % tbenkert
        if strcmp(this.readType,'nav')
            this.NCol = this.NCol(1);
        else
            this.NCol = this.NCol(end);
        end
        
        %{
        elseif (strcmp(this.readType,'img') && this.scanNumber == 2)
            this.NCol = this.NCol(end);
        elseif strcmp(this.readType,'default')
            this.NCol = this.NCol(end);
        else
            this.NCol = this.NCol(1);
        end
